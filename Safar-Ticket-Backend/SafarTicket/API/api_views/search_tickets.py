...
class SearchTicketsAPIView(APIView):
    def post(self, request):
        ...
        try:
            query_filters = []
            query_filters.append({"term": {"departure_city_name": origin_city_name}})
            query_filters.append({"term": {"destination_city_name": destination_city_name}})
            ...
            if company_name:
                query_filters.append({"term": {"transport_company_name": company_name}})
                
            if travel_class:
                query_filters.append({"term": {"travel_class": travel_class}})
