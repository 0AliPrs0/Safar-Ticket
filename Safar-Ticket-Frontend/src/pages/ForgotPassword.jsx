            ...
            <AuthFormContainer title={t('forgot_password_title')}>
                ...
                <form onSubmit={handleSubmit} className="space-y-6 text-start">
                    <div>
                        ...
                        <input id="email" dir="ltr" className="w-full px-4 py-3 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg" type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="email@example.com" required />
                    </div>
                    ...
                    <p className="text-center text-sm text-gray-600 dark:text-gray-400">
                        {t('remember_password')}{" "}
                        <Link to="/login" className="font-semibold text-accent-orange hover:underline">{t('back_to_login')}</Link>
                    </p>
                </form>
            </AuthFormContainer>
        </>
